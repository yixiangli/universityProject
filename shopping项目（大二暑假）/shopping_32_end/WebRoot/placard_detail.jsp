...
<c:if test="${publish == null}">
  <jsp:forward page="showPublishDetail.do"></jsp:forward>
</c:if>
	...
	<table width="100%"  border="0" cellpadding="0" cellspacing="0">
      ...
      <table width="100%" height="155"  border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <table>
			<tr>
              <td height="24" class="tableBorder_T_dashed"></td>
            </tr>
          </table>
          </td>
        </tr>
            ...
            <tr valign="top">
              <td height="134" align="center">
                  <table width="96%" height="79"  border="0" cellpadding="0" cellspacing="0" class="noborder">
                    <tr>                     
                      <td width="95%" height="27" class="font1">${publish.getTitle()}</td>
                    </tr>
                    <tr>                      
                      <td height="27">&nbsp;&nbsp;${publish.getContent()}</td>
                    </tr>
                    <tr>                      
                      <td height="27">发布日期：<fmt:formatDate value="${publish.getPublishTime()}" pattern="yyyy-MM-dd"></fmt:formatDate></td>
                    </tr>
                    <tr>
                      <td align="center" ><input type="button" class="negative button" onClick="history.back(-1);" value="返回"></td>                      
                    </tr>
                  </table>
                 </td>
            </tr>
