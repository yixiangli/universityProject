...
<%@ include file="include_head.jsp" %>
 <c:if test="${empty goods}">
   <jsp:forward page="favorite.do"></jsp:forward>
 </c:if>
			    ...
			    <c:if test="${not empty goods}">
                 <c:forEach items="${goods }" var="good">
                  <table width="96%" height="30"  border="0" cellpadding="0" cellspacing="0" class="tableBorder_B_dashed">
                    <tr>
                      <td width="45%" align="center"><img class="tip2" src="${good.getPhoto()}" width="150" height="100"></td>
                      <td width="25%"><a href="goodsDetail.do?id=${good.getId()}">${good.getGname()}</a></td>
                      <td height="15">￥${good.getSalPrice()} </td>
