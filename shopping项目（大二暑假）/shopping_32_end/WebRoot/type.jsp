...
<%   
   ...
   if(categories == null){
%>
   <jsp:forward page="type.do"></jsp:forward>
<%}%>
<c:if test="${empty goods } && ${empty categories }">
   <c:redirect url="type.do"></c:redirect>
</c:if>
<html>
<head>
<title>奋斗电子商城</title>
            ...
            <tr align="center" valign="top">
              <td height="134" align="center">
                  <table width="90%" height="23"  border="0" cellpadding="0" cellspacing="0" class="tableBorder_B_dashed">
                    <tr>
                      <td height="23"> 当前选择的类别：[ ${pname } ]->[ ${cname } ]</td>
                      </tr>
                  </table>
                  ...
                  <table width="90%" height="23"  border="0" cellpadding="0" cellspacing="0" class="noborder">
                    <tr>
                      <td width="5%" align="center">${goodNum.count}.</td>
                      <td width="45%"><a href="goodsDetail.do?id=${good.getId()}">${good.getGname()}</a></td>
					  ...
					  <c:choose>
                         ...
                         <c:otherwise>
                            <input type="button" class="primary button" onclick="javascript:showMsg('暂无商品');" value="暂时缺货">
                         </c:otherwise>
                      </c:choose>
					  </td>
                    </tr>
