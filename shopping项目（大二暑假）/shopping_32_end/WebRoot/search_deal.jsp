            ...
            <tr valign="top">
              <td height="134" align="center">
                 <table width="90%" height="23"  border="0" cellpadding="0" cellspacing="0" class="tableBorder_B_dashed">
                    <tr>
                      <td height="23"> [${Name}]&nbsp;查询关键字：[${keyWord}]</td>
                      </tr>
                  </table>
                  
                  <c:choose>
                     <c:when test="${searchGoods.size() > 0}">
                     <c:forEach items="${searchGoods }" var="good" varStatus="goodNum">
			      <table width="90%" height="79"  border="0" cellpadding="0" cellspacing="0" class="noborder">			        
                    <tr>
                      <td width="5%" rowspan="4" align="center" valign="top">${goodNum.count}.</td>
                      <td width="45%" height="95" rowspan="4" align="center"><img src="${good.getPhoto()}" width="184" height="119"></td>
                      <td width="50%" height="27" class="font2"><a href="goodsDetail.do?id=${good.getId()}">${good.getGname()}</a></td>
                    </tr>
                    <tr>
                      <td height="27">￥${good.getSalPrice()}(${good.getGdiscount()}折) </td>
                    </tr>
                    <tr>
				  ...
				  <hr align="center" width="92%" size="1">				  
				     ...
				     <c:when test="${searchGoods.size() == 0 }"><br><br><br>您搜索的商品没有找到,请重新输入你要搜索商品的关键字！！！</c:when>
				  </c:choose>
                 </td>
            </tr>
            <tr>
