...
<c:if test="${empty sellGoods }">
  <c:redirect url="sellGoods.do"></c:redirect>
</c:if>
	...
	<table width="100%"  border="0" cellpadding="0" cellspacing="0">
      ...
      <table width="183" height="144"  border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <table width="88%"  border="0" cellspacing="0" cellpadding="0" id="table">
        ...
        <tr>
          <td height="189" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            ...
            <tr valign="top">
              ...
              <c:forEach items="${sellGoods }" var="good" varStatus="goodNum">
                  <table width="96%" height="30"  border="0" cellpadding="0" cellspacing="0" class="tableBorder_B_dashed">
                    <tr>
                      <td width="15%" align="center">No.${goodNum.count}</td>                                                
                      <td width="35%"><a href="goodsDetail.do?id=${good.getId()}">${good.getGname()}</a></td>
                      <td height="20">￥${good.getSalPrice() } </td>
                      <td width="30%" align="center">
                        
                         <c:choose>
                            <c:when test="${good.getNumber() - good.getSalCount()>0 }">
                               <input type="button" class="positive button" onclick="addCart(${good.getId() })" value="购买">
                            </c:when>
