...
<c:if test="${categories == null}">
   <jsp:forward page="showChildrenCategory.do"></jsp:forward>
</c:if>
          ...
          <td align="center" valign="top"><table width="100%" height="120"  border="0" cellpadding="0" cellspacing="0"> 
              <tr> 
                <td valign="top" background="../images/manage_center_subList.gif"><table width="100%" height="36"  border="0" cellpadding="0" cellspacing="0"> 
                    <tr> 
                      <td width="98%" align="right"><a href="subType_add.jsp?pid=${pid}">[<img src="../images/list.gif" width="11" height="13">&nbsp;添加小分类信息]</a></td> 
                      <td width="2%">&nbsp;</td> 
                    </tr> 
                </table></td> 
              </tr> 
                  ...
                  <td valign="top"> <table width="100%" height="14"  border="0" cellpadding="0" cellspacing="0"> </table> 
                    <table width="100%" height="48"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#CCCCCC" bordercolorlight="#FFFFFF"> 
                      ...
                      <tr style="padding:5px;"> 
                        <td  align="center">${categoryNum.count}.</td> 
                        <td height="20" align="center">${categoryName} </td>
                        <td height="20" align="center">${category.getName()}</td>
                        <td align="center"><a href="javascript:alert('暂无此页面');"><img src="../images/modify.gif" width="15" height="15"></a></td>
