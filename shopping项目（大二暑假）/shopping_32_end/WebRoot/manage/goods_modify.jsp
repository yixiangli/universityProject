...
<script type="text/javascript" src="../JS/zhang.js"></script>
</head>
<body>
  ...
  <tr>
    ...
    <td align="center" valign="top"><table width="100%" height="120"  border="0" cellpadding="0" cellspacing="0">
      ...
      <table width="92%" height="192"  border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td valign="top">
   			 <form action="goodsModify.do" method="post" name="form1" enctype="multipart/form-data">
			    ...
			    <table width="100%"  border="0" align="center" cellpadding="-2" cellspacing="-2" bordercolordark="#FFFFFF">
                  <tr>
                    ...
                    <td width="42%">&nbsp;
                      <select name="typeID" class="ctextarea" id="typeID">					  
					   <option value="" selected>${cname}</option>	
                      </select> 
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td colspan="3">&nbsp;
                      <input name="gname" value="${good.getGname()}" type="text" class="Sytle_text" id="bookID2" size="50">&nbsp;&nbsp;</td>
                    </tr>
                  <tr>
                    <td height="30">&nbsp;市场价格：</td>
                    <td>&nbsp;
                          <input name="marketPrice" value="${good.getMarketPrice()}" type="text" class="Sytle_text" id="price">(元)
                    </td>
                    <td>&nbsp;商城价格：</td>
                    <td>&nbsp;
                       <input name="salPrice" value="${good.getSalPrice()}" type="text" class="Sytle_text" id="price">(元)
                    </td>
                  </tr>
                  <tr>                    
                    <td height="30">&nbsp;折 扣 率：</td>
                    <td>&nbsp;
                        <input name="gdiscount" value="${good.getGdiscount()}" type="text" class="Sytle_text" id="price">
                    </td>
                    <td>&nbsp;是否特价：</td>
                    <td>
                    <c:choose>
                       <c:when test="${good.getBargainPrice() == 1}">
                           <input name="bargainPrice" type="radio" class="noborder" value="1" checked>是<input name="bargainPrice" type="radio" class="noborder" value="0">否
                       </c:when>
                       <c:otherwise>
                           <input name="bargainPrice" type="radio" class="noborder" value="1">是<input name="bargainPrice" type="radio" class="noborder" value="0" checked>否
                       </c:otherwise>
                    </c:choose>
                    </td>
                  </tr>                 
                  ...
                  <tr>
                    ...
                    <td colspan="3"><span class="style5">&nbsp; </span>
                      <textarea name="info" cols="60" rows="5"  id="introduce">${good.getInfo()}</textarea>
                    </td>
                  </tr>
                  <tr>
