...
<c:if test="${empty User}">
     <c:redirect url="./memberManager.do?nowpage=0"></c:redirect>
</c:if>
<html>
<head>
<title>后台管理</title>
          ...
          <table width="100%" height="14"  border="0" cellpadding="0" cellspacing="0">
            ...
            <table width="100%" height="48"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#CCCCCC" bordercolorlight="#FFFFFF">
              <tr>
                ...
                <td width="15%" align="center">会员等级</td>
                <td width="15%" align="center">创建时间</td>
                <td width="10%" align="center">冻结</td>
              </tr>
              
              <c:forEach items="${User}"  var="user" varStatus="userNum">
              
              <tr style="padding:5px;">
                <td align="center">${userNum.count}.</td>
                <td height="24" align="center"><a href="memberDetail.jsp?username=${user.username}">${user.username}</a></td>
                <td align="center">${user.realname}</td>
                <td align="center">${user.email}</td>
                <td align="center">￥${user.spend}</td>
                
               	<c:if test="${user.type==1}"> <td align="center">VIP</td></c:if>
                <c:if test="${user.type==0}"> <td align="center">普通会员</td></c:if>
           
                <td align="center">${user.pdate}</td>
                <c:if test="${user.state==1}"> <td align="center"><a href="freezeUser.do?userId=${user.id}"><img src="../images/thaw.gif" alt="释放" width="13" height="15"></a></c:if>
                <c:if test="${user.state==0}"> <td align="center"><a href="freezeUser.do?userId=${user.id}"><img src="../images/freeze.gif" alt="冻结" width="13" height="15"></a></c:if>
      ...
      <table width="100%" height="46"  border="0" cellpadding="0" cellspacing="0">
       ...
       <table width="100%"  border="0" cellspacing="0" cellpadding="0">
			  <tr>
				...
				当前页数：[<%=userVo.getNowpage()+1 %>/<%=userVo.getPagecount() %>]
				
				<a href="./memberManager.do?nowpage=0">第一页</a>&nbsp;&nbsp;<a href="./memberManager.do?nowpage=<%=userVo.getPreviouspage() %>">上一页</a>&nbsp;&nbsp;
				
				<a href="./memberManager.do?nowpage=<%=userVo.getNextpage() %>">下一页&nbsp;</a><a href="./memberManager.do?nowpage=<%=userVo.getLastpage()%>">&nbsp;&nbsp;最后一页&nbsp;</a>
