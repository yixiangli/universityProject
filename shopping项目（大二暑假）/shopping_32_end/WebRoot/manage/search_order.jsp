...
<c:if test="${empty orders}">
     <c:redirect url="./searchOrder.do?nowpage=0&orderType=${param.orderType}"></c:redirect>
</c:if>
           ...
           <table id="orderTable" width="94%"  border="0" cellpadding="3" cellspacing="3">
            ...
            <table width="100%"  border="0" cellspacing="0" cellpadding="0">
			 <tr>
				...
				<a href="./searchOrder.do?nowpage=0&orderType=${param.orderType}">第一页</a>&nbsp;&nbsp;<a href="./searchOrder.do?nowpage=<%=orderVo.getPreviouspage() %>&orderType=${param.orderType}">上一页</a>&nbsp;&nbsp;
				
				<a href="./searchOrder.do?nowpage=<%=orderVo.getNextpage() %>&orderType=${param.orderType}">下一页&nbsp;</a><a href="./searchOrder.do?nowpage=<%=orderVo.getLastpage()%>&orderType=${param.orderType}">&nbsp;&nbsp;最后一页&nbsp;</a>
				</td>
			  </tr>
			</table>	
		  </td>
