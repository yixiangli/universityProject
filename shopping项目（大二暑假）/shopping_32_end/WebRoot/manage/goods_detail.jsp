        ...
        <tr>
          <td valign="top">
                   ...
                   <tr>
                    ...
                    <tr>
                      <td width="37%" rowspan="5" align="center"><img src="../${good.getPhoto() }" width="150" height="100"></td>
                      <td width="63%">商品类型：[${cname}] </td>
                    </tr>
                    <tr>
                      <td>市场价：￥${good.getMarketPrice()}(元)</td>
                    </tr> 
                    <tr>
                      <td>商城价：￥${good.getSalPrice()}(元) </td>
                    </tr>
                    <tr>
                      <td>折扣率：${good.getGdiscount()} </td>
                    </tr> 
                    <tr>
                      <td>
                      <c:if test="${good.getBargainPrice() == 1}">特价商品 </c:if>
                      </td>
                    </tr> 
                    ...
                    <tr>
                      <td colspan="2">&nbsp;&nbsp;创建人：admin  创建时间：<fmt:formatDate value="${good.getPdate()}" pattern="yyyy-MM-dd"></fmt:formatDate></td>
                    </tr>                   
                    <tr>
                      <td colspan="2" align="center">
                         <input name="Submit" type="submit" class="primary button" onClick="history.back(-1);" value="返回">
   			          </td>
                    </tr>
                  </table>
          </td>
