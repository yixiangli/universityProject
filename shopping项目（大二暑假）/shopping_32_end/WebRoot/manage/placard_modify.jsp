...
<c:if test="${publish == null}">
  <jsp:forward page="publishModify.do"></jsp:forward>
</c:if>
      ...
      <table width="92%" height="192"  border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td valign="top">
			    ...
			    <input type="hidden" name="id" value="${publish.getId()}">
			    <table width="100%"  border="0" align="center" cellpadding="-2" cellspacing="-2" bordercolordark="#FFFFFF">
                  <tr>
                    <td height="30">公告标题：</td>
					<td><input name="title" value="${publish.getTitle()}" type="text" id="title" size="60"></td>
                  </tr> 
				  <tr>
                    <td width="14%" >&nbsp;公告内容：</td>
                    <td width="86%">
                        <textarea name="content" cols="60" rows="15" class="textarea">${publish.getContent()}</textarea></td>
                  </tr> 
                  <tr>
                    <td height="30"></td>
					<td>
					<div style="margin:20px auto; width:480px;">
                                                                 发布时间： <input name="publishTime" value="<fmt:formatDate value="${publish.getPublishTime()}" pattern="yyyy-MM-dd"></fmt:formatDate>" type="text" id="txtBeginDate" style="width:100px;" />
                                                                 失效时间：<input name="outTime" value="<fmt:formatDate value="${publish.getOutTime()}" pattern="yyyy-MM-dd"></fmt:formatDate>" type="text" id="txtEndDate" style="width:100px;" />
                    </div>
					</td>
                  </tr> 
