...
<c:if test="${empty bargainGoods }">
  <c:redirect url="bargainGoods.do"></c:redirect>
</c:if>
...
<script language='JavaScript' src='JS/jquery-1.8.js'></script>
        ...
        <tr>
          <td height="189" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            ...
            <tr valign="top">
              ...
              <c:forEach items="${bargainGoods }" var="good">
                  <table width="98%" height="79"  border="0" cellpadding="0" cellspacing="0" class="noborder">
                    <tr>
                      ...
                      <td width="63%" height="27" class="font2"><a href="goodsDetail.do?id=${good.getId() }">${good.getGname() }</a></td>
                    </tr>
                    <tr>
                      <td height="27" style="text-decoration:line-through;">市场价：￥${good.getMarketPrice() }</td>
                    </tr>
                    <tr>
                      <td height="27" style="color:#FF0000">商城价：￥${good.getSalPrice() }(${good.getGdiscount() }折) </td>
                    </tr>                   
                    <tr>
                      <td><c:choose>
                          <c:when test="${good.getNumber() - good.getSalCount()>0 }">现在有货<input type="button" class="positive button" value="购买" onclick="addCart(${good.getId() })"></c:when>
