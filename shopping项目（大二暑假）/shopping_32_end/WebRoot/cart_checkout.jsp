                 ...
                 <form method="post" action="submitCart.do" name="form_checkout">
                    <table width="100%" height="339"  border="0" cellpadding="0" cellspacing="0">
                     ...
                     <tr>
                        ...
                        <td width="74%"><input class="positive button" id="modifyAddressButton" type="button" value="修改" onclick="modifyAddress()">
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td class="addressItem" name="phone">${user.tel}</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td height="26" colspan="2" align="center">开具发票</td>
                        <td><input type="checkbox" name="needinvoice" checked class="noborder"></td>
                      </tr>
                      <tr>
                        <td height="26" colspan="2" align="center">抬头：</td>
                        <td><INPUT NAME="invoicetitle" ID="invoicetitle" TYPE="text" size=16></td>
                      </tr>
                      <tr>
                        <td height="26" colspan="2" align="center">内容：</td>
                        <td><SELECT NAME="invoicecontent" id="invoicecontent">
                      ...
                      <tr>
                        ...
                        <td>
                        	...
                        	<input type="radio" name="recievemethod" value=2>申通快递 
                        	<input type="radio" name="recievemethod" value=3>圆通快递 
						</td>
                      </tr> 
                           <tr>
                      ...
                      <tr align="center">
                        <td colspan="3"><input type="button" class="positive button" value="提交" onclick="submitCart()" >
                           &nbsp;
                           <input type="button" class="button" value="返回" onClick="history.back(1);"></td>                        </tr>
                    </table>
</form>
			  </td>
            </tr>
