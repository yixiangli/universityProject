...
<c:if test="${empty newGoods }">
   <c:redirect url="newGoods.do"></c:redirect>
</c:if>
<html>
<head>
<title>奋斗电子商城</title>
        ...
        <tr>
          <td height="189" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            ...
            <tr valign="top">
              ...
              <c:forEach items="${newGoods }" var="good">
			       <table width="98%" height="79"  border="0" cellpadding="0" cellspacing="0" class="noborder">
                    <tr>
                      <td width="37%" height="95" rowspan="5" align="center"><img class="tip2" src="${good.getPhoto()}" width="150" height="100"></td>
