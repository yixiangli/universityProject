...
<script type="text/javascript" src="inputnotes/alterinputnotes.js"></script>
    ...
    <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
      ...
      <table width="100%"  border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
		  ...
		  <form action="" method="post" name="modifypwd">
		  <table width="80%" border="0" cellspacing="-2" cellpadding="-2" class="tableBorder_B_dashed" >
		   <tr>              
              <td height="28" class="font2">修改密码</td>
              <td height="28" align="right"><input type="button" class="positive button" value="修改" onclick="updatePwd()"></td>
            </tr>
            <tr>              
              <td width="18%" height="30" align="center">用 户 名：</td>
              <td width="82%" class="word_grey">${sessionScope.user.getUsername() }</td>
            </tr>
            <tr>
              <td height="28" align="center">E-mail：</td>
              <td height="28">${sessionScope.user.getEmail() }</td>
            </tr>  
            <tr>
              <td height="28" align="center">原始密码：</td>
              <td height="28"><input name="oldpwd" id="oldpwd" type="password" size="20" maxlength="20">
                <span class="word_orange">*</span></td>
            </tr>
            <tr>
              <td height="28" align="center">修改密码：</td>
              <td height="28"><input name="newpwd" id="newpwd" type="password" size="20" maxlength="20">
                <span class="word_orange">*</span> </td>
            </tr>              
           </table>
           </form>
           <form action="" method="post" name="modifyuser">
		   <table width="80%"  border="0" cellspacing="-2" cellpadding="-2" class="tableBorder_B_dashed" > 
            <tr>              
              <td height="28" class="font2">修改地址簿</td>
              <td height="28" align="right"><input type="button" class="positive button" value="修改" onclick="addressInfo();"></td>
            </tr>
            <tr>
              <td height="28" align="center">姓&nbsp;&nbsp;&nbsp;&nbsp;名：</td>
              <td height="28"><input name="realname" id="realname1" type="text" maxlength="10" value="${sessionScope.user.getRealname() }">
                </td>
            </tr>  
            <tr>
              <td height="28" align="center">地&nbsp;&nbsp;&nbsp;&nbsp;址：</td>
              <td class="word_grey"><input name="address" id="address1" type="text"size="50" value="${sessionScope.user.getAddress() }"> 
               </td>
            </tr>               
            <tr>
              <td height="28" align="center">地&nbsp;&nbsp;&nbsp;&nbsp;区：</td>           
                <td >
              	<span id="test"></span><div><font color='red'>原地址：${sessionScope.user.getArea() }</font></div>
               </td>
                </tr>  
                     
            <tr>
              <td height="28" align="center">邮&nbsp;&nbsp;&nbsp;&nbsp;编：</td>
              <td class="word_grey"><input name="postcode" id="postcode1" type="text" maxlength="6" value="${sessionScope.user.getPostcode() }">
                       </td>
            </tr>
            <tr>
              <td height="28" align="center">联系电话：</td>
              <td><input name="tel" type="text" id="telephone1"  value="${sessionScope.user.getTel() }"> 
              </td>
            </tr>             
          </table>
		  </form>
		  <table width="80%" border="0" cellspacing="-2" cellpadding="-2" class="tableBorder_B_dashed" >
		   <tr>              
              ...
              <td height="28" align="right"><input type="button" value="查看" class="pill button" onClick="window.location.href='favorite.do?uid=${sessionScope.user.getId()}'"></td>
            </tr>
          </table>
