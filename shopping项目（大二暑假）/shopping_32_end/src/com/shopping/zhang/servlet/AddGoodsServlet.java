...
public class AddGoodsServlet extends HttpServlet {
	private static final long serialVersionUID = 4323227892524067558L;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			// �����ܹ������ļ������ڹ����ռ��images��
			String filepath = this.getServletContext().getRealPath("/")+ "images\\goods\\" + newFileName;
		...
		GoodsServiceImpl.getInstance().saveGoods(good);
